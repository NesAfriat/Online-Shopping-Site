...
public class MarketCostumerAsyncTests extends MarketTests{
    ...
    void purchaseShoppingCartSuccess() throws InterruptedException {
        ...
        Thread visitor4Thread = new Thread(){
            public void run(){
               responseVis4[0] = purchaseShoppingCart(visitor4.getId(),creditCard,date,cvs,country,city,street);
            }
        };
        ...
        Thread visitor1Thread = new Thread(){
            public void run(){
                responseVis1[0] = purchaseShoppingCart(visitor2.getId(),creditCard,date,cvs,country,city,street);
            }
        };
