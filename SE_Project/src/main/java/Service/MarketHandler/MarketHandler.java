...
//TODO: update function names in useCase docs
public class MarketHandler {
    ...
    public Response<List<PurchaseHistoryResponse>> purchaseShoppingCart(int visitorID, String creditCardNumber, String date, String cvs, String country, String city, String street) {
        return marketRepresentative.purchaseCart(visitorID, creditCardNumber, date, cvs, country, city, street);
    }
    ...
    public Response<MemberResponse> cancelMemberShip(int visitorId, String memberUserName) throws InnerLogicException {
    ...
    public Response<List<ShopResponse>> getAllSHops (int visitorId)  {
        return marketRepresentative.getAllShops(visitorId);
    }
