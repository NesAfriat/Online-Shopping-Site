...
import {postAssignShopOwner} from "../../../../api";
    ...
    const submitHandler = async (e) => {
        ...
        await postAssignShopOwner(
            ...
            if (res.errorOccurred) {
                ...
                alert("Successfully assigned new owner!");
            }
        });
    };
    ...
    return (
        <div>
            <form onSubmit={submitHandler}>
                ...
                <div>
                    <button className={classes.actions}>Assign new owner</button>
                </div>
            </form>
        </div>
    );
