...
class ManagementInfoUnitTests {
    ...
    void setUp() throws InnerLogicException {
        ...
        sO1 = RoleController.getInstance().createShopOwner(null, shop1, VisitorController.getInstance().getMember(useName1));
        ...
        sM1 =  rc.createShopManager(useName1,shop1,visitorController.getMember(useName2));

        sO2 = rc.createShopOwner(useName1,shop1,visitorController.getMember(useName2));

        sM2 = rc.createShopManager(useName3, shop2, visitorController.getMember(useName3));
    ...
    void setManagerPermissionSuccess() throws InnerLogicException {
        ...
        assertTrue(sM.getPermissionsInShop().contains(PermissionManagement.Notification));
        sM = rc.setManagerPermission(visitor3.getId(),shopid2,1,useName4);
        assertTrue(sM.getPermissionsInShop().contains(PermissionManagement.PurchaseHistory));
    }
    @Test
    ...
    void setManagerPermissionFai2() throws InnerLogicException {
        ...
        ShopOwner s = rc.createShopOwner(useName3,shop1,visitorController.getMember(useName3));
        //add him to a shop
        addRoleToAShop(s,shopid1,useName3);
        //add user name 4 to shop 1 the assignee is use name 3
        addAssigneeManager(s,rc.createShopManager(useName4,shop1,visitorController.getMember(useName4)),shopid1,useName4);
        rc.setShopsMapper(shopsMapper);
        rc.setMembersMapper(membersMapper);
